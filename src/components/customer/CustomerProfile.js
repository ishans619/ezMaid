...
class CustomerProfile extends Component {
    ...
    handleGetProfile = () => {
        ...
        const customerId = user.data.pid;
        ...
        ezmaidApi.getCustomerProfile(user, customerId)
            .then(response => {
                ...
                this.setState({ adharCardNumber: response.data.adharCardNumber })
                this.setState({ panCardNumber: response.data.panCardNumber })
    ...
    render() {
        const { isCustomer, fName, mName, lName, contactNumber, address, email, adharCardNumber, panCardNumber, username, message, isError, isSuccess, showError, showSuccess } = this.state
                                    ...
                                    <div class="card-body pt-3">
                                        ...
                                        <div class="tab-content pt-2">
                                            ...
                                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-4 label">Adhar Card Number</div>
                                                    <div class="col-lg-9 col-md-8">{adharCardNumber}</div>
                                                </div>

                                                <div class="row">
                                                    <div class="col-lg-3 col-md-4 label">PAN Card Number</div>
