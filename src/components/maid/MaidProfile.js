...
class MaidProfile extends Component {
    ...
    render() {
        const { isMaid, fName, mName, lName, contactNumber, address, email, adharCardNumber, panCardNumber, username, message, isError, isSuccess, showError, showSuccess } = this.state
